          ...
          <div class="flex min-h-full flex-col gap-4 p-4 py-0">
            ...
            <section class="border-t border-slate-200/80 pt-3">
              ...
              <div class="grid grid-cols-2 gap-2">
                <div
                  class="flex min-h-[90px] items-center gap-2.5 rounded-xl border px-3 py-2 shadow-2xs"
                  :class="
                ...
                >
                  <i
                    class="fa-solid text-[22px] shrink-0"
                    :class="
                      property.isIllegalBuilding
                ...
                <div
                  class="relative flex min-h-[90px] flex-col items-center justify-center rounded-xl border border-slate-200 bg-slate-50/80 px-2 py-2 text-center shadow-2xs"
                >
                  <span
                  ...
                  <div class="group relative mt-1 inline-block">
                    <span
                      class="inline-flex items-center gap-1 text-[11px] font-bold px-2 py-0.5 rounded-md bg-white border border-slate-200/90 shadow-2xs whitespace-nowrap cursor-help transition-all hover:border-slate-300"
                      :class="buildingAgeCategory.class"
                    >
                      <span>{{ buildingAgeCategory.label }}</span>
                      <i
                        class="fa-solid fa-circle-info text-[9px] opacity-70 group-hover:opacity-100"
                        aria-hidden="true"
                      ></i>
                    </span>
              ...
              >
                ...
                <div class="route-facility-toggle-row">
                  <span class="route-facility-toggle-label">
                    안전 시설 지도에 표시
                    <span
                      v-if="isRouteFacilitiesLoading"
                      class="route-facility-toggle-loading"
                      >불러오는 중…</span
                    >
                  </span>
                  <button
