...
<template>
  ...
  >
    <!-- 매물 썸네일 -->
    <div
      class="relative w-28 h-28 rounded-lg overflow-hidden bg-slate-100 shrink-0"
    >
      <img
        :src="
      ...
      >
        <span
          class="text-xs"
          :class="{ 'text-rose-500': property.isBookmarked }"
        >
    ...
    <div class="flex-1 flex flex-col justify-between min-w-0">
      <div>
        <div class="flex items-center gap-1.5 mb-1">
          ...
          <span
            class="px-1.5 py-0.5 rounded text-[11px] font-semibold bg-slate-100 text-slate-600"
          >
        ...
        <h3
          class="font-bold text-slate-900 text-base group-hover:text-blue-600 transition-colors truncate"
        >
          {{ formattedPrice }}
        </h3>
      ...
      <div
        class="flex items-center justify-between text-[11px] text-slate-500 mt-2"
      >
        <span
