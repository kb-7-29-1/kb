...
본 문서는 **살고싶오(29반 1팀) - 낯선 지역 이주 시 주거 및 골목 귀갓길 안전 불안을 해소하기 위한, 안심 주거 매칭 플랫폼**의 프론트엔드(Vue 3)와 백엔드(Spring), DB(MySQL) 및 공공 API 연동 전체 흐름을 자동화하여 검증하기 위한 **E2E(End-to-End) 전용 시나리오 테스트 가이드**입니다.
